...
while True:
    user = api.get_user('YashAbhyankar5')
    api.update_profile(name=f'Yash Abhyankar|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Yash Abhyankar|{follower_count(user)} Followers')
